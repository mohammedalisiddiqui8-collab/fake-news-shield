...
/* ─── LOCKED PALETTE ─── */
const P = {
  bg: "#17130F",text:"#EDE6D9",secondary:"#B39977",sage:"#8A6A45",verified:"#7F9278",warning:"#A85C4D",gold:"#8A6A45",border:"#46382A",surface:"#241C15",
};
...
export default function HeroScene() {
  ...
  useEffect(() => {
    ...
    scene.fog = new THREE.FogExp2(0x17130F, 0.05);
